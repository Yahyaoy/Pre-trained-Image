...
#                                                                             
# PROGRAMMER: Yahya Khalid M. Alshaikh Eids
# DATE CREATED:                                  
# REVISED DATE: 
...
def calculates_results_stats(results_dic):
    ...
    """
    # Initialize counts and statistics variables
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            num_correct_dogs += 1
            # Check if the breed is correctly classified
            if results_dic[key][4] == 1:
                num_correct_breed += 1
        # Check if the image is not a dog
        else:
            num_correct_notdogs += 1

    # Calculate additional statistics
    num_images_dog = num_correct_dogs - num_correct_notdogs
    num_images_notdog = num_images - num_images_dog
    pct_match = (num_correct_dogs / num_images_dog) * 100
    pct_correct_dogs = (num_correct_dogs / num_images_dog) * 100
    pct_correct_breed = (num_correct_breed / num_correct_dogs) * 100

    # Handle the case when num_images_notdog is zero
    if num_images_notdog > 0:
        pct_correct_notdogs = (num_correct_notdogs / num_images_notdog) * 100
    else:
   ...
   # Create results statistics dictionary
    results_stats_dic = {
        'n_images': num_images,
        'num_images_dog': num_images_dog,
        'n_dogs_img': num_correct_dogs,
        'n_notdogs_img': num_images_notdog,
        'n_match': num_correct_dogs,
