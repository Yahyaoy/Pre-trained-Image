...
# 
def print_result(results_dic, results_stats_dic, model,
    ...
    print(f"Number of Dog Images: {results_stats_dic['num_images_dog']}")
    print(f"Number of 'Not-a' Dog Images: {results_stats_dic['n_notdogs_img']}")
    print(f"Percentage Match: {results_stats_dic['pct_match']}%")
    print(f"Percentage Correct Dogs: {results_stats_dic['n_correct_dogs']}%")
    print(f"Percentage Correct Breed: {results_stats_dic['n_correct_breed']}%")
    print(f"Percentage Correct 'Not-a' Dog: {results_stats_dic['n_correct_notdogs']}%")
